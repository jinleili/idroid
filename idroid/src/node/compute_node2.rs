...
use super::BindingGroupSettingNode3;
...
#[allow(dead_code)]
pub struct ComputeNode2 {
    pub setting_node: BindingGroupSettingNode3,
...
impl ComputeNode2 {
    pub fn new(
        ...
        inout_buffers: Vec<&BufferObj>, inout_tv: Vec<(&wgpu::TextureView, Option<(StorageTextureAccess, TextureFormat)>)>, shader_module: &ShaderModule,
    ) -> Self {
        ComputeNode2::new_with_push_constants(device, threadgroup_count, uniforms, inout_buffers, inout_tv, shader_module, None)
    }
    ...
    pub fn new_with_push_constants(
        ...
        let setting_node = BindingGroupSettingNode3::new(device, uniforms, inout_buffers, inout_tv, vec![], visibilitys);
        ...
        ComputeNode2 { setting_node, pipeline, threadgroup_count }
    }
